/**
 * Created by bebop on 2014-12-24.
 */
/* 서버쪽으로 데이터를 보내보자 */
var sendData = function() {
    /* 일단 계산할 팩토리알 숫자를 가져오자. ( jquery 이용 ) */
    var inputValue = parseInt( $('input[name=myinput]').val() );
//    var inputValue2 = $('input[name=actorID]')
